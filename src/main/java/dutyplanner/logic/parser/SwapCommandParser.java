...
import static dutyplanner.logic.parser.CliSyntax.PREFIX_ALLOCATED_DATE;
import static dutyplanner.logic.parser.CliSyntax.PREFIX_REQUESTED_DATE;
...
public class SwapCommandParser implements Parser<SwapCommand> {
    ...
    public SwapCommand parseForPersonnelUser(String args, String userName) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_ALLOCATED_DATE, PREFIX_REQUESTED_DATE)
            ...
            throw new ParseException(String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, SwapCommand.MESSAGE_USAGE));
        }
