...
import dutyplanner.commons.util.AppUtil;

import static java.util.Objects.requireNonNull;
import static dutyplanner.commons.util.AppUtil.checkArgument;
...
public class Company {
    ...
    public Company(String company) {
        ...
        AppUtil.checkArgument(isValidCompany(company), MESSAGE_CONSTRAINTS);
        value = company;
    }
