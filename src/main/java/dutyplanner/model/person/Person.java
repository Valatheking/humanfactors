package dutyplanner.model.person;

import static dutyplanner.commons.util.CollectionUtil.requireAllNonNull;
...
import dutyplanner.commons.util.CollectionUtil;
...
public class Person {
    ...
    public Person(Nric nric, Company company, Section section, Rank rank, Name name,
        ...
        CollectionUtil.requireAllNonNull(nric, company, section, rank, name, phone, tags);
        this.nric = nric;
    ...
    public Person(Nric nric, Company company, Section section, Rank rank, Name name,
        ...
        CollectionUtil.requireAllNonNull(nric, company, section, rank, name, phone, tags, password, userType);
        this.nric = nric;
        this.company = company;
        this.section = section;
        this.rank = rank;
